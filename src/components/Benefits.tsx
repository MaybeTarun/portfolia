function Benefits() {
  return (
    <>
      <h1 className="text-[clamp(2rem,4vw,4rem)] tracking-tighter font-extrabold font-mono -mb-2 text-[#2D2A32]">Ready when you are</h1>
      <p className="text-[clamp(0.8rem,3vw,1.3rem)] tracking-tight font-light font-mono text-[#2D2A32] mb-8">The instant alternative to hiring a developer.</p>
      
      <div className="w-full px-4 md:px-0 md:w-1/2 flex flex-col md:flex-row gap-3 md:gap-6">

        <div className="bg-[#2D2A32] rounded-[2rem] p-8 text-white md:w-1/2 flex flex-col justify-between">
          <h3 className="text-xl font-semibold mb-4 text-white">An Awesome Developer</h3>
      ...
      <div className="w-full px-4 md:px-0 md:w-1/2 flex flex-col mt-3 md:mt-6 md:flex-row gap-3 md:gap-6">
        ...
        <div className="bg-[#DAD9DA] rounded-[2rem] p-8 text-white md:w-1/2 flex flex-col justify-between">
