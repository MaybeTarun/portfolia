...
const Hero = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-[#EFF0EF] flex flex-col justify-center items-center text-[#2D2A32]'>
      ...
      <p className="w-full px-4 md:px-0 py-8 md:py-12 text-center text-[clamp(1rem,3vw,1.5rem)] leading-snug tracking-tight font-normal">Replace weeks of recruiting with minutes.<br className="hidden md:block"/> Hire a cool freelance developer now.</p>
