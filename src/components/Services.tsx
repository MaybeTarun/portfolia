...
function Services() {
  ...
  return (
    <>
      <motion.h2 className="text-[clamp(2rem,4vw,4rem)] tracking-[-0.2rem] font-extrabold text-[#2D2A32]" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0 }} viewport={{ once: true }}>Your all-in-one builder</motion.h2>
